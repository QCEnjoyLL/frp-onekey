...
export FRPS_INIT="https://raw.githubusercontent.com/QCEnjoyLL/frp-onekey/master/frps.init"
export aliyun_download_url="https://code.aliyun.com/Nerocats/frps-onekey/raw/master"
...
str_install_shell="https://raw.githubusercontent.com/QCEnjoyLL/frp-onekey/master/install-frps.sh"
shell_update(){
    fun_clangcn "clear"
...
fun_clangcn(){
    ...
    echo ""
    echo "+------------------------------------------------------------+"
    echo "|   frps for Linux Server, Author Clang ，Mender QCEnjoyLL   |" 
